"""
Django settings for lumina_english project.
...
SECRET_KEY = 'django-insecure-y-5_9yrj%sa&0$g#wpg=8ftk(k5v8v479q^0xe-@r-k9y1+@w!'
...
ROOT_URLCONF = 'lumina_english.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "lumina_english", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'lumina_english.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "lumina_english" / "static",
]
